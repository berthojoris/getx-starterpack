            ...
            children: <Widget>[
              ...
              Container(
                child: AppBar(
                  ...
                  title: FxText.sh1("Leading Icon", fontWeight: 600),
                ),
              ),
              ...
              Container(
                ...
                child: AppBar(
                  backgroundColor: theme.scaffoldBackgroundColor,
                  title: FxText.sh1("Trailing Icons", fontWeight: 600),
                  actions: <Widget>[
                    Padding(
              ...
              Container(
                ...
                child: AppBar(
                  backgroundColor: theme.scaffoldBackgroundColor,
                  title: FxText.sh1("Simple Menu", fontWeight: 600),
                  actions: <Widget>[
                    PopupMenuButton(
              ...
              Container(
                ...
                child: AppBar(
                  backgroundColor: theme.scaffoldBackgroundColor,
                  title: FxText.sh1("Menu with icons", fontWeight: 600),
                  actions: <Widget>[
                    PopupMenuButton(
                      itemBuilder: (BuildContext context) {
              ...
              Container(
                ...
                child: AppBar(
                  backgroundColor: theme.scaffoldBackgroundColor,
                  title: FxText.sh1("Full app bar", fontWeight: 600),
                  leading: IconButton(
