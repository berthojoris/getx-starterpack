  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          ...
          title: FxText.sh1("Account", fontWeight: 600),
        ),
        body: Center(
            child: isInProgress
                ? Row(
                ...
                : FxButton(
                    ...
                    child: FxText.b2("Create Account",
                        fontWeight: 600,
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Container(
              ...
              child: Center(child: FxText.sh1("Thanks!", fontWeight: 700)),
            ),
            Container(
              margin: EdgeInsets.only(top: 16),
              child: Center(
