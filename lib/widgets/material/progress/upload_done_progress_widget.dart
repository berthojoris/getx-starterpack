  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          ...
          title: FxText.sh1("Upload File", fontWeight: 600),
        ),
        body: Center(
            child: isInProgress
                ? Row(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Container(
              ...
              child: Center(child: FxText.sh1("Success!", fontWeight: 700)),
            ),
            Container(
              margin: EdgeInsets.only(top: 16),
              child: Center(
                  child: FxText.b2("Your file upload successful",
                      fontWeight: 600)),
            ),
            Container(
              margin: EdgeInsets.only(top: 8),
              child: Center(
                  child: FxText.caption("Now you can check your file",
                      fontWeight: 500)),
            ),
            Container(
              margin: EdgeInsets.only(top: 16),
