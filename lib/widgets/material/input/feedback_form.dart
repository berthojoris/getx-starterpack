              ...
              child: Column(
                ...
                children: <Widget>[
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: <Widget>[
                      FxText.b1("Send us your feedback!", fontWeight: 700),
                      Container(
                          margin: FxSpacing.top(4),
                          child: FxText.b2(
                              "Do you have a suggestion or found a bug?",
                              fontWeight: 500)),
                      FxText.b2("Let us know by fill this form",
                          fontWeight: 500),
                    ],
                  ),
                  FxSpacing.height(20),
                  FxText.sh1("How was your experience?", fontWeight: 700),
                  FxSpacing.height(20),
                  Row(
