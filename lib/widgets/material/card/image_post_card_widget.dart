  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          ...
          title: FxText.sh1("Post", fontWeight: 600),
        ),
        body: ListView(
          ...
          children: <Widget>[
            Container(
              ...
              child: FxText.b1("Recent Post", fontWeight: 600),
            ),
            Container(
              margin: EdgeInsets.only(left: 16, right: 16, top: 16),
              child: _SimpleCard(
            ...
            Container(
              ...
              child: FxText.b1("Old Posts", fontWeight: 700),
            ),
            Container(
              ...
              child: Column(
                ...
                children: <Widget>[
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: <Widget>[
                      FxText.sh1(widget.title!, fontWeight: 600),
                      Container(
                        margin: EdgeInsets.only(top: 2),
                        child: FxText.b2(widget.description!,
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                            ...
                            Container(
                              ...
                              child: FxText.caption(widget.like.toString(),
                                  fontWeight: 600),
                            ),
                            Container(
                            ...
                            Container(
                              margin: EdgeInsets.only(left: 4),
                              child: FxText.caption(widget.view.toString(),
                                  fontWeight: 600),
                            ),
                          ],
                        ),
