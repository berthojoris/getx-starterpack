                ...
                Row(
                  children: <Widget>[
                    ...
                    FxContainer.rounded(
                      ...
                      child: Center(
                        child:
                            FxText.sh2("A", color: theme.colorScheme.onPrimary),
                      ),
                    )
                  ],
                ),
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      Container(
                        ...
                        child: FxText.sh1("No Result!", fontWeight: 700),
                      ),
                      FxText.sh2("Try another keyword", fontWeight: 500),
                    ],
                  ),
                )),
      ],
      ...
      child: Row(
        children: <Widget>[
          ...
          Expanded(
            child: Container(
                padding: FxSpacing.fromLTRB(16, 0, 8, 0),
                child: FxText.sh2(suggestion, fontWeight: 500)),
          )
        ],
      ),
    );
