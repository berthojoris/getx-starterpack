  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          title: FxText.sh1("Toggle Button", fontWeight: 600),
        ),
        body: Container(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      Container(
                        ...
                        child: FxText.sh2("Simple", fontWeight: 700),
                      ),
                      ToggleButtons(
                      ...
                      Container(
                        ...
                        child: FxText.sh2("Filled", fontWeight: 700),
                      ),
                      ToggleButtons(
                        splashColor: theme.colorScheme.primary.withAlpha(48),
                      ...
                      Container(
                        margin: EdgeInsets.only(bottom: 8, top: 16),
                        child: FxText.sh2("Bordered", fontWeight: 600),
                      ),
                      ToggleButtons(
                        splashColor: theme.colorScheme.primary.withAlpha(48),
                        color: theme.colorScheme.onBackground,
                      ...
                      Container(
                        margin: EdgeInsets.only(bottom: 8, top: 16),
                        child: FxText.sh2("Curved", fontWeight: 600),
                      ),
                      ToggleButtons(
                        splashColor: theme.colorScheme.primary.withAlpha(48),
                        color: theme.colorScheme.onBackground,
