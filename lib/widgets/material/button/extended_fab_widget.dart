  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          title: FxText.sh1("Extended FAB", fontWeight: 600),
        ),
        floatingActionButton: FloatingActionButton.extended(
          ...
          elevation: 2,
          label: FxText.sh2("New contact".toUpperCase(),
              fontWeight: 600,
                ...
                return Dismissible(
                  ...
                  child: Padding(
                    ...
                    child: Row(
                      ...
                      children: <Widget>[
                        CircleAvatar(
                          child: FxText.sh1(_contactList[index].name[0],
                        ...
                        Expanded(
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              children: <Widget>[
                                FxText.sh1(_contactList[index].name,
                                    fontWeight: 600),
                                FxText.b2(_contactList[index].number,
                                    fontWeight: 500),
                              ],
