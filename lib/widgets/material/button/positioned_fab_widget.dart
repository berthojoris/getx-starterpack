  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          ...
          title: FxText.sh1("Positioned FAB", fontWeight: 700),
        ),
        extendBody: true,
        key: _scaffoldKey,
