...
class _FABWithTabsWidgetState extends State<FABWithTabsWidget>
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        bottom: TabBar(
          ...
          tabs: [
            Tab(
              child: FxText.b1("Tab 1", fontWeight: 600),
            ),
            Tab(
              child: FxText.b1("Tab 2", fontWeight: 600),
            ),
          ],
        ),
        leading: InkWell(
        ...
        title: FxText.sh1("FAB with Tabs", fontWeight: 600),
      ),
  ...
  Widget getTabContent(String text) {
    return Scaffold(
      backgroundColor: theme.backgroundColor,
      body: Center(
        child: FxText.h6(text, color: theme.colorScheme.onBackground),
      ),
    );
  }
