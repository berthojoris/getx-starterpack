...
import 'package:digital/widgets/custom/navigation/custom_bottom_navigation.dart';
      ...
      body: SizedBox.expand(
        child: PageView(
          ...
          children: <Widget>[
            ...
            Container(
              child: Center(
                child: FxText.sh1("Item 1", fontWeight: 600),
              ),
            ),
            Container(
              child: Center(
                child: FxText.sh1("Item 2", fontWeight: 600),
              ),
            ),
            Container(
              child: Center(
                child: FxText.sh1("Item 3", fontWeight: 600),
              ),
            ),
            Container(
              child: Center(
                child: FxText.sh1("Item 4", fontWeight: 600),
              ),
            ),
          ],
        ),
