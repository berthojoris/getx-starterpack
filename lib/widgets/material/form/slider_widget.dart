  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          title: FxText.sh1("Sliders", fontWeight: 600),
        ),
        body: Column(
          ...
          children: <Widget>[
            Container(
              ...
              child: FxText.sh1("Slider", fontWeight: 600, letterSpacing: 0.2),
            ),
            Container(
              child: Slider(
                value: _sliderValue1,
            ...
            Container(
              ...
              child: FxText.sh1("Labeled Slider",
