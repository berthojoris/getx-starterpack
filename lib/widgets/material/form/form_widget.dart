  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          title: FxText.sh1("Form", fontWeight: 600),
        ),
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Container(
                ...
                child: FxText.sh1("Date & Time Picker",
                    fontWeight: 600, letterSpacing: 0.2),
              ),
              Container(
                padding: EdgeInsets.symmetric(vertical: 8, horizontal: 16),
              ...
              Container(
                padding:
                    EdgeInsets.only(left: 16, right: 16, top: 16, bottom: 8),
                child:
                    FxText.sh1("Sliders", fontWeight: 600, letterSpacing: 0.2),
              ),
              Container(
                child: Slider(
                  value: _sliderValue1,
              ...
              Container(
                ...
                child:
                    FxText.sh1("Switch", fontWeight: 600, letterSpacing: 0.2),
              ),
              Container(
                  padding: EdgeInsets.symmetric(vertical: 8, horizontal: 16),
                  child: Switch(
              ...
              Container(
                padding:
                    EdgeInsets.only(left: 16, right: 16, top: 16, bottom: 0),
                child: FxText.sh1("Radio Buttons",
                    fontWeight: 600, letterSpacing: 0.2),
              ),
              Container(
                padding: EdgeInsets.symmetric(vertical: 8, horizontal: 16),
