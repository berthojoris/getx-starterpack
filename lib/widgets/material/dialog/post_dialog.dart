        ...
        children: <Widget>[
          ...
          Container(
            ...
            child: Column(
              ...
              children: <Widget>[
                FxText.h5("How do you get up and go forward", fontWeight: 700),
                Container(
                    margin: FxSpacing.only(top: 8),
                    child:
                        FxText.b2(description, fontWeight: 500, height: 1.2)),
                Container(
                    ...
                    children: <Widget>[
                      ...
                      Expanded(
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: <Widget>[
                            FxText.sh1("Zakariyah Cline", fontWeight: 600),
                            FxText.sh2("@zaka_cline", fontWeight: 500),
                          ],
                        ),
                      ),
                      FxText.b1("26 May", fontWeight: 600),
                    ],
                  ),
                ),
              ],
