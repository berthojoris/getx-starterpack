  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          ...
          title: FxText.sh1("Switch", fontWeight: 600),
        ),
        body: Container(
            ...
            child: Center(
              child: Column(
                children: <Widget>[
                  MergeSemantics(
                    child: ListTile(
                      title: FxText.b1('Simple', fontWeight: 600),
                  ...
                  MergeSemantics(
                    child: ListTile(
                      title: FxText.b1('Thumb Color', fontWeight: 600),
                      trailing: CupertinoSwitch(
                  ...
                  MergeSemantics(
                    child: ListTile(
                      title: FxText.b1('Track Color', fontWeight: 600),
                      trailing: CupertinoSwitch(
                        activeColor: theme.colorScheme.primary,
