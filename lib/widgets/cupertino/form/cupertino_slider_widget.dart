  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          ...
          title: FxText.sh1("Cupertino Slider", fontWeight: 600),
        ),
        body: Container(
              ...
              child: Column(
                ...
                children: <Widget>[
                  Container(
                    ...
                    child: FxText.sh2("Simple Slider", fontWeight: 600),
                  ),
                  Container(
                  ...
                  Container(
                    padding: EdgeInsets.only(top: 16, left: 16, bottom: 8),
                    child: FxText.sh2("Divisions Slider", fontWeight: 600),
                  ),
                  Container(
                    child: CupertinoSlider(
                      value: _progress2,
                  ...
                  Container(
                    padding: EdgeInsets.only(top: 16, left: 16, bottom: 8),
                    child: FxText.sh2("Thumb Color", fontWeight: 600),
                  ),
                  Container(
                    child: CupertinoSlider(
                      value: _progress3,
