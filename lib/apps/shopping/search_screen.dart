                    ...
                    child: FxContainer(
                      ...
                      child: Row(
                        ...
                        children: <Widget>[
                          ...
                          FxSpacing.width(8),
                          FxText.sh2("Sort", fontWeight: 600, letterSpacing: 0)
                        ],
                      ),
                    ),
                  ),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          FxSpacing.height(8),
          FxText.sh2("Type", fontWeight: 600, letterSpacing: 0),
          Container(
            child: _TypeChipWidget(),
          ),
          FxSpacing.height(8),
          FxText.sh2("Color", fontWeight: 600, letterSpacing: 0),
          FxSpacing.height(16),
          Row(
            children: <Widget>[
              InkWell(
          ...
          FxSpacing.height(16),
          FxText.sh2("Size", fontWeight: 600, letterSpacing: 0),
          FxSpacing.height(16),
          Row(
