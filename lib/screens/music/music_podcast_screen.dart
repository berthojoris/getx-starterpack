  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      children: <Widget>[
        Container(
          child: Center(
            child: FxText.sh1("Podcast", fontWeight: 600, letterSpacing: 0.2),
          ),
        ),
        Container(
          ...
          child: Row(
            ...
            children: <Widget>[
              FxText.sh1("Recent Shows", fontWeight: 600, letterSpacing: 0),
              FxText.b2("View All",
        ...
        Container(
          ...
          child: Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: <Widget>[
              FxText.sh1("Popular Shows", fontWeight: 700, letterSpacing: 0),
              FxText.b2("View All",
                  color: theme.colorScheme.primary, fontWeight: 500)
            ],
          ),
      ...
      child: Column(
        children: <Widget>[
          ...
          Container(
              ...
              child: FxText.b2(text, letterSpacing: 0.2, fontWeight: 500))
        ],
      ),
    );
  }
