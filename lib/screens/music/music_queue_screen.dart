        ...
        return MaterialApp(
            ...
            home: Scaffold(
                appBar: AppBar(
                  ...
                  title: FxText.h6("Queue", fontWeight: 700),
                ),
                body: ListView(
                  children: <Widget>[
                    Container(
                            ...
                            child: Row(
                              children: <Widget>[
                                ...
                                Container(
                                    ...
                                    child:
                                        FxText.caption(_time, fontWeight: 600)),
                                Expanded(
                                  child: SliderTheme(
                    ...
                    Container(
                      padding: EdgeInsets.all(24),
                      child: FxText.sh2("Up Next", fontWeight: 700),
                    ),
                    Container(
