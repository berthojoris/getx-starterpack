  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      children: <Widget>[
        Container(
          child: Center(
            child: FxText.sh1("Playlist", fontWeight: 600, letterSpacing: 0.2),
          ),
        ),
        Container(
        ...
        Container(
            ...
            child: FxText.b1("All Tracks", fontWeight: 600)),
        Container(
      ...
      child: Column(
        children: <Widget>[
          ...
          Container(
            ...
            child: FxText.b2(title, fontWeight: 600, letterSpacing: 0.2),
          )
        ],
      ),
    );
        ...
        children: <Widget>[
          ...
          Expanded(
            child: Column(
              ...
              children: <Widget>[
                FxText.sh2(name, fontWeight: 600, letterSpacing: 0.2),
                FxText.b2(album,
          ...
          Container(
            child: FxText.b1(duration, fontWeight: 600, letterSpacing: 0.2),
          ),
        ],
      ),
    );
