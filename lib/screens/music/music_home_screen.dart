  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      children: <Widget>[
        Container(
          child: Center(
            child: FxText.sh1("Home", fontWeight: 600, letterSpacing: 0.2),
          ),
        ),
        Container(
          padding: EdgeInsets.only(top: 12, left: 20, bottom: 4),
          child: FxText.sh1("Recently", fontWeight: 600, letterSpacing: 0),
        ),
        ...
        Container(
          ...
          child: FxText.sh1("Trending", fontWeight: 600, letterSpacing: 0),
        ),
        SingleChildScrollView(
          scrollDirection: Axis.horizontal,
          child: Row(
        ...
        Container(
          ...
          child:
              FxText.sh1("Events of 2020", fontWeight: 600, letterSpacing: 0),
        ),
        Container(
      ...
      child: Column(
        children: <Widget>[
          ...
          Container(
              ...
              child: FxText.b2(text, fontWeight: 500))
        ],
      ),
    );
  }
