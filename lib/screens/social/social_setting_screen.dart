      ...
      children: [
        ...
        FxContainer.bordered(
          ...
          child: Row(
            ...
            children: <Widget>[
              Column(
                children: <Widget>[
                  FxText.sh1("15", fontWeight: 700),
                  Container(
                    margin: EdgeInsets.only(top: 8),
                    child:
                        FxText.sh2("Posts", fontWeight: 600, letterSpacing: 0),
                  ),
                ],
              ),
              Column(
        ...
        Container(
          ...
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              FxText.sh2("Complete your profile",
