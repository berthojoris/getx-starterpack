        ...
        children: <Widget>[
          ...
          Container(
            ...
            child: Column(
              ...
              children: <Widget>[
                FxText.sh1("Mandarin Oriental", fontWeight: 600),
                Container(
                      ...
                      Row(
                        children: <Widget>[
                          ...
                          Container(
                              ...
                              child:
                                  FxText.b2("London bridge", fontWeight: 500)),
                        ],
                      ),
                      Row(
                        children: <Widget>[
                          FxText.sh2("4.6", fontWeight: 500),
                          Container(
          ...
          Expanded(
            child: Container(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: <Widget>[
                  FxText.b1(name, fontWeight: 500),
                  Container(
                      margin: EdgeInsets.only(top: 4),
                      child: FxText.button("- " + review,
