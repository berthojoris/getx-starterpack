...
import 'package:digital/screens/hotel/hotel_room_screen.dart';
                    ...
                    child: Container(
                      child: Center(
                        child: Column(
                          ...
                          children: <Widget>[
                            FxText.caption("Check in", fontWeight: 500),
                            FxText.b1("28 May", fontWeight: 600),
                          ],
                        ),
                      ),
                    ),
                    ...
                    child: Container(
                      child: Center(
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: <Widget>[
                            FxText.caption("Check out", fontWeight: 500),
                            FxText.b1("31 May", fontWeight: 600),
                          ],
                        ),
                      ),
                    ),
                    ...
                    child: Container(
                      child: Center(
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: <Widget>[
                            FxText.caption("Person", fontWeight: 500),
                            FxText.b1("2 Couple", fontWeight: 600),
                          ],
                        ),
                      ),
                    ),
                ...
                children: <Widget>[
                  Row(
                    ...
                    children: <Widget>[
                      ...
                      FxText.sh1("\$" + widget.price.toString(),
                          fontWeight: 600),
                    ],
                  ),
                  Container(
