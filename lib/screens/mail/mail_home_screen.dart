                                      ...
                                      child: Padding(
                                        ...
                                        child: Column(
                                          children: <Widget>[
                                            ...
                                            FxText.b2(_mailList[index].title,
                                                fontWeight:
                                                    _mailList[index].isRead
                                                        ? 500
                                                        : 600,
                                                letterSpacing: 0),
                                            FxText.b2(_mailList[index].message,
                                                fontWeight: 500,
                                                letterSpacing: 0)
                                          ],
                                          crossAxisAlignment:
              ...
              children: <Widget>[
                ...
                Container(
                  ...
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: <Widget>[
                      FxText.sh2("Aishah Mcconnell", fontWeight: 600),
                      FxText.b2("ais@mcc.com", fontWeight: 500),
                      Container(
                        margin: EdgeInsets.only(top: 8, bottom: 12),
                        child: TextButton(
                            onPressed: () {},
                            child: FxText.b2("Manage all accounts",
                                fontWeight: 600)),
                      )
                    ],
                  ),
              ...
              children: <Widget>[
                ...
                Container(
                  ...
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: <Widget>[
                      FxText.sh2("Liana Fitzgeraldl", fontWeight: 600),
              ...
              children: <Widget>[
                ...
                Container(
                  ...
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: <Widget>[
                      FxText.sh2("Sally Lee", fontWeight: 600),
              ...
              children: <Widget>[
                ...
                Container(
                  ...
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: <Widget>[
                      FxText.sh2("Shamima Ballard", fontWeight: 600),
          ...
          Container(
            ...
            child: Row(
              ...
              children: <Widget>[
                ...
                Container(
                  margin: EdgeInsets.only(left: 16),
                  child: FxText.sh2("Add another account",
            ...
            child: TextButton(
                ...
                child: Row(
                  ...
                  children: <Widget>[
                    ...
                    Padding(
                      padding: EdgeInsets.only(left: 8),
                      child: FxText.b2("Sign out from all account",
                          fontWeight: 500),
                    ),
                  ],
                )),
