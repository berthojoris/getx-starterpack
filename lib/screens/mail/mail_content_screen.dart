        ...
        child: Column(
          children: <Widget>[
                    ...
                    child: Column(
                      children: <Widget>[
                        Row(
                          ...
                          children: <Widget>[
                            FxText.sh1("Quincy Larson",
                                fontWeight: 600, letterSpacing: 0),
                            Container(
                                margin: EdgeInsets.only(left: 4),
                                child: FxText.caption("4 day ago",
                        ...
                        Row(
                          crossAxisAlignment: CrossAxisAlignment.end,
                          children: <Widget>[
                            FxText.b2("to", fontWeight: 500),
                            Container(
                                margin: EdgeInsets.only(left: 2),
                                child: FxText.b2("me", fontWeight: 500)),
                            Container(
                                margin: EdgeInsets.only(left: 2),
                                child: Icon(
            ...
            Container(
              ...
              child: FxText.b2(_messageText, fontWeight: 500),
            ),
            Container(
              margin: EdgeInsets.only(top: 24),
              child: Row(
                      ...
                      child: Row(
                        children: <Widget>[
                          ...
                          Container(
                            ...
                            child: FxText.b2("Replay", fontWeight: 600),
                          ),
                        ],
                      )),
                  TextButton(
                      ...
                      child: Row(
                        children: <Widget>[
                          ...
                          Container(
                            margin: EdgeInsets.only(left: 8),
                            child: FxText.b2("Forward", fontWeight: 600),
                          ),
                        ],
                      )),
                  TextButton(
                      ...
                      child: Row(
                        children: <Widget>[
                          ...
                          Container(
                            margin: EdgeInsets.only(left: 8),
                            child: FxText.b2("Share", fontWeight: 600),
                          ),
                        ],
                      )),
                ],
