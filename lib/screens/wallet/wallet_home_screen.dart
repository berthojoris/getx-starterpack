  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          ...
          title: FxText.sh1("Wallet", fontWeight: 600),
        ),
        ...
        body: ListView(
          ...
          children: <Widget>[
            ...
            Container(
              ...
              child: FxText.caption("LAST TRANSACTION",
                  fontWeight: 700,
                  color: theme.colorScheme.onBackground.withAlpha(220)),
            ),
            Container(
          ...
          children: <Widget>[
            Expanded(
              child: Container(
                ...
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: <Widget>[
                    FxText.sh1(widget.name, fontWeight: 600, letterSpacing: 0),
                    FxText.caption(widget.date, fontWeight: 500),
                  ],
                ),
              ),
            ),
            Row(
              children: <Widget>[
                ...
                FxText.sh1("\$ " + widget.amount.toString(), fontWeight: 600),
              ],
            )
          ],
        ),
        ...
        children: <Widget>[
          FxContainer.bordered(
            ...
            child: Column(
              ...
              children: <Widget>[
                FxText.h5("Mastercard", fontWeight: 700, color: Colors.black),
                Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: <Widget>[
                    FxText.overline("END BALANCE",
                ...
                Row(
                  ...
                  children: <Widget>[
                    FxText.b2("1457 XXXX XXXX 2145",
                        fontWeight: 600,
                        letterSpacing: 0.3,
                        color: Colors.black),
                    FxText.b1("08/26", fontWeight: 700, color: Colors.black),
                  ],
                )
              ],
            ),
          ...
          FxContainer(
            ...
            child: Column(
              ...
              mainAxisAlignment: MainAxisAlignment.spaceEvenly,
              children: <Widget>[
                FxText.h5("Visa", fontWeight: 700, color: Colors.black),
                Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: <Widget>[
                    FxText.overline("END BALANCE",
                ...
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: <Widget>[
                    FxText.b2("2486 XXXX XXXX 6842",
                        fontWeight: 600,
                        letterSpacing: 0.3,
                        color: Colors.black),
                    FxText.b1("07/25", fontWeight: 600, color: Colors.black),
                  ],
                )
              ],
            ),
              ...
              children: <Widget>[
                Row(
                  ...
                  children: <Widget>[
                    ...
                    FxText.sh1("Add card".toUpperCase(),
                        letterSpacing: 0.8,
                        fontWeight: 700,
                        color: theme.colorScheme.onPrimary),
                  ],
      ...
      child: Column(
        children: <Widget>[
          ...
          Padding(
            ...
            child: FxText.caption(actionText, fontWeight: 700),
          )
        ],
      ),
    );
