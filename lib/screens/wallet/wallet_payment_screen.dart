    ...
    return Scaffold(
        ...
        body: ListView(
          ...
          children: <Widget>[
                  ...
                  child: FxContainer(
                    ...
                    child: Column(
                      children: <Widget>[
                        ...
                        Container(child: FxText.sh2("Carlos", fontWeight: 600)),
                        FxText.overline("1874596",
                            color:
                  ...
                  child: FxContainer(
                    ...
                    child: Column(
                      children: <Widget>[
                        ...
                        Container(
                            child: FxText.sh2("Caprice", fontWeight: 600)),
                        FxText.overline("2589631",
                            color:
                                theme.colorScheme.onBackground.withAlpha(200),
                            letterSpacing: 0),
                      ],
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            Container(
                                child: FxText.sh2("Jenson", fontWeight: 700)),
                            FxText.overline("1598746",
            ...
            FxButton.block(
              onPressed: () {},
              child: FxText.b2("Press \& Hold to Transfer Money",
                  fontWeight: 600,
                  color: theme.colorScheme.onPrimary,
                  letterSpacing: 0.3),
              elevation: 0,
