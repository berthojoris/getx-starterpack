  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          ...
          title: FxText.sh1("Crypto", fontWeight: 600),
          actions: <Widget>[
            Container(
          ...
          children: <Widget>[
                    ...
                    RichText(
                      text: TextSpan(
                        children: <TextSpan>[
                          TextSpan(
                              text: "\$ ",
                              style: FxTextStyle.h6(letterSpacing: 0)),
                          TextSpan(
                              text: "3824",
                              style: FxTextStyle.h5(letterSpacing: 0)),
                          TextSpan(
                              text: ".75",
                              style: FxTextStyle.h6(letterSpacing: 0)),
                        ],
            ...
            Container(
              ...
              child: Row(
                ...
                children: <Widget>[
                  FxText.caption("TODAY RATE", fontWeight: 600),
                  Icon(
                    MdiIcons.refresh,
                    color: theme.colorScheme.onBackground,
                    size: 22,
            ...
            Container(
              ...
              child: FxText.caption("ACTIVITY", fontWeight: 600),
            ),
            FxContainer.bordered(
              color: Colors.transparent,
              margin: EdgeInsets.all(20),
      ...
      child: Row(
        ...
        children: <Widget>[
          Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: <Widget>[
              FxText.b1(title, fontWeight: 700),
              FxText.caption(subtitle, fontWeight: 400),
            ],
          ),
          FxText.sh2(activity,
...
class _SingleRate extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Row(
        children: <Widget>[
          Expanded(child: FxText.sh1(name, fontWeight: 600)),
          FxText.b1("\$ " + rate.toStringAsFixed(2), fontWeight: 600),
          Container(
            ...
            child: Row(
              ...
              children: <Widget>[
                ...
                FxText.caption(changes.abs().toStringAsFixed(2),
                    color: changes > 0
