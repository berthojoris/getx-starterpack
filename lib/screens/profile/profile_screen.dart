            ...
            Container(
              ...
              child: Column(
                children: <Widget>[
                  ...
                  FxText.h5("Natalia Dyer", fontWeight: 700, letterSpacing: 0),
                  FxText.sh2("UI Designer", fontWeight: 600),
                ],
              ),
            ),
            Container(
                ...
                children: <Widget>[
                        ...
                        child: FxContainer.bordered(
                          ...
                          child: Column(
                            children: <Widget>[
                              ...
                              Container(
                                margin: EdgeInsets.only(top: 4),
                                child: FxText.overline("Followings",
                                    fontWeight: 600, letterSpacing: 0.2),
                              ),
                            ],
                          ),
                        ...
                        child: FxContainer.bordered(
                          ...
                          child: Column(
                            children: <Widget>[
                              ...
                              Container(
                                margin: EdgeInsets.only(top: 4),
                                child: FxText.overline("Followers",
                                    fontWeight: 600, letterSpacing: 0.2),
                              ),
                            ],
                          ),
                  ...
                  Container(
                    ...
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: <Widget>[
                        FxText.sh1("About", letterSpacing: 0, fontWeight: 700),
                        Container(
                          margin: EdgeInsets.only(top: 8),
                          child: FxText.sh2(_aboutText,
                              letterSpacing: 0.1, fontWeight: 500, height: 1.3),
                        ),
                        Container(
                          margin: EdgeInsets.only(top: 24),
                          child: FxText.sh1("Feed",
