        ...
        body: ListView(
          children: [
            ...
            Container(
              ...
              child: FxText.caption("RENEW SUBSCRIPTION",
                  color: theme.colorScheme.onBackground,
                  fontWeight: 600,
                  muted: true),
            ),
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: ElevatedButton(
                      ...
                      child: FxText.caption("CONTACT US",
                          letterSpacing: 0.4,
                          fontWeight: 600,
        ...
        children: [
          Row(
            ...
            children: [
              ...
              FxText.sh2("\$" + value.toString(),
                  color: theme.colorScheme.primary, fontWeight: 600),
            ],
          ),
          FxText.b2(description, color: theme.colorScheme.onBackground),
        ],
      ),
    );
  }
