              ...
              children: [
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      FxText.caption("How far",
                          color: theme.colorScheme.onBackground, xMuted: true),
                      FxText.b1("3.2 km",
                          color: theme.colorScheme.onBackground),
                      Container(
                        margin: FxSpacing.top(8),
                        child: FxText.caption("Charges per hour",
                            color: theme.colorScheme.onBackground,
                            xMuted: true),
                      ),
                      FxText.b1("\$ 19", color: theme.colorScheme.onBackground),
                      Container(
                        margin: FxSpacing.top(8),
                        child: FxText.caption("Rating",
                            color: theme.colorScheme.onBackground,
                            xMuted: true),
                      ),
                      Row(
