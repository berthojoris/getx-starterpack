      ...
      children: <Widget>[
                ...
                children: <Widget>[
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        FxText.b1("Malia Jackson",
                            color: theme.colorScheme.onBackground,
                            fontWeight: 600),
                        FxText.b2("Mal@son.com",
                            color: theme.colorScheme.onBackground,
                            fontWeight: 500),
                      ],
                    ),
                ...
                child: Row(
                  ...
                  children: <Widget>[
                    Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: <Widget>[
                        FxText.b2("Refer Friends",
                            color: theme.colorScheme.onBackground,
                            fontWeight: 600),
                        FxText.caption("Earn \$100",
            ...
            children: <Widget>[
              Row(
                children: <Widget>[
                  ...
                  Container(
                    margin: EdgeInsets.only(left: 16),
                    child: FxText.sh2("Add money to wallet",
              ...
              Container(
                ...
                child: Row(
                  children: <Widget>[
                    ...
                    Container(
                      margin: EdgeInsets.only(left: 16),
                      child: FxText.sh2("Address setting",
                          color: theme.colorScheme.onBackground.withAlpha(240),
                          letterSpacing: 0,
                          fontWeight: 600),
                    ),
              ...
              Container(
                ...
                child: Row(
                  children: <Widget>[
                    ...
                    Container(
                      margin: EdgeInsets.only(left: 16),
                      child: FxText.sh2("Payment setting",
                          color: theme.colorScheme.onBackground.withAlpha(240),
                          letterSpacing: 0,
                          fontWeight: 600),
                    ),
              ...
              Container(
                ...
                child: Row(
                  children: <Widget>[
                    ...
                    Container(
                      margin: EdgeInsets.only(left: 16),
                      child: FxText.sh2("Customer support",
                          color: theme.colorScheme.onBackground.withAlpha(240),
                          letterSpacing: 0,
                          fontWeight: 600),
                    ),
        ...
        Center(
          child: FxButton(
              ...
              child: FxText.caption("Logout".toUpperCase(),
                  letterSpacing: 0.5,
                  color: theme.colorScheme.onPrimary,
                  fontWeight: 600)),
        )
