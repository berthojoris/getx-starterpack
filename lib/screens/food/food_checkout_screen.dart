        ...
        body: ListView(
          children: <Widget>[
            Container(
              ...
              child: FxText.sh2("Saved Address",
                  color: theme.colorScheme.onBackground, fontWeight: 600),
            ),
            Container(
            ...
            Container(
              margin: EdgeInsets.only(left: 20, right: 20, top: 20),
              child: FxText.sh2("Payment Method",
                  color: theme.colorScheme.onBackground, fontWeight: 600),
            ),
            Container(
              margin: EdgeInsets.only(left: 20, right: 20, top: 8),
            ...
            Container(
              ...
              child: FxText.b2("Order amount : \$39.99",
                  color: theme.colorScheme.onBackground, fontWeight: 600),
            ),
            Container(
              margin: EdgeInsets.only(top: 20),
              child: Center(
                child: FxButton(
                  ...
                  child: FxText.caption("Place Order".toUpperCase(),
