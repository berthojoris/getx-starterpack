    ...
    return Scaffold(
      ...
      children: <Widget>[
        ...
        Container(
          ...
          child: FxText.b1("Category", fontWeight: 600),
        ),
        Container(
        ...
        Container(
          ...
          child: Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: <Widget>[
              FxText.b1("Recommended", fontWeight: 600),
              FxText.b2("View all",
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Container(
              ...
              child: FxText.b2(name, muted: true, fontWeight: 600),
            ),
            Container(
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          ...
          elevation: 0,
          title: FxText.h6("Notifications", fontWeight: 600),
          actions: <Widget>[
            Container(
