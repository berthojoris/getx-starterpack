  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          ...
          elevation: 0,
          centerTitle: true,
          title: FxText.sh1("Feedback", fontWeight: 600),
        ),
        body: ListView(
          ...
          children: <Widget>[
            Container(
              child: Center(
                child: FxText.sh1("How was last order?",
            ...
            Center(
              child: FxButton(
                ...
                child: FxText.b2("Review".toUpperCase(),
