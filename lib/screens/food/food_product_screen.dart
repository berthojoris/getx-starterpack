  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      children: <Widget>[
        ...
        Container(
          margin: EdgeInsets.only(left: 20, top: 20),
          child: FxText.sh2("Select Size", fontWeight: 700),
        ),
        Container(
        ...
        Container(
          margin: EdgeInsets.only(left: 20, top: 20),
          child: FxText.sh2("Topping", fontWeight: 700),
        ),
        Container(
              ...
              children: <Widget>[
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      FxText.sh2("Quick Order",
                          color: theme.colorScheme.onBackground,
                          fontWeight: 600,
                          height: 1),
                      FxText.caption("Are you too hungry?",
                          letterSpacing: 0.2,
                          fontSize: 10,
                          fontWeight: 400,
                          color: theme.colorScheme.onBackground,
        ...
        Container(
          ...
          child: Row(
            ...
            children: <Widget>[
              FxText.h6("Total \$" + getPrice().toString(),
            ...
            child: Row(
              ...
              children: <Widget>[
                ...
                Container(
                  ...
                  child: Center(
                    child: FxText.b2(toppingCheese ? "Added" : "Add \$2",
                        color: toppingCheese
                            ? theme.colorScheme.onPrimary
                            : theme.colorScheme.onBackground),
                  ),
              ...
              child: Row(
                ...
                children: <Widget>[
                  ...
                  Container(
                    ...
                    child: Center(
                      child: FxText.b2(toppingTomato ? "Added" : "Add \$3",
                          color: toppingTomato
                              ? theme.colorScheme.onPrimary
                              : theme.colorScheme.onBackground),
                    ),
              ...
              child: Row(
                ...
                children: <Widget>[
                  ...
                  Container(
                    ...
                    child: Center(
                      child: FxText.b2(toppingCorn ? "Added" : "Add \$5",
                          color: toppingCorn
                              ? theme.colorScheme.onPrimary
                              : theme.colorScheme.onBackground),
                    ),
              ...
              child: Row(
                ...
                children: <Widget>[
                  ...
                  Container(
                    ...
                    child: Center(
                      child: FxText.b2(toppingChicken ? "Added" : "Add \$10",
                          color: toppingChicken
                              ? theme.colorScheme.onPrimary
                              : theme.colorScheme.onBackground),
                    ),
                          ...
                          children: <Widget>[
                            Container(
                              child: Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: <Widget>[
                                  FxText.sh2("Food Wallet",
                                      color: theme.colorScheme.onBackground,
                                      fontWeight: 600),
                                  FxText.caption("Insufficient balance",
                                      fontSize: 12,
                            ...
                            TextButton(
                                onPressed: () {},
                                child: FxText.caption("Add Money".toUpperCase(),
                                    color: theme.colorScheme.primary,
                                    fontWeight: 600,
                                    letterSpacing: 0.2)),
                          ],
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                            ...
                            FxButton(
                                ...
                                child: FxText.caption("Place".toUpperCase(),
                                    letterSpacing: 0.2,
                                    fontWeight: 600,
                                    color: theme.colorScheme.onPrimary)),
                          ],
