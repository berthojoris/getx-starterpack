  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          ...
          title: FxText.h6("Seller", fontWeight: 600),
        ),
        body: ListView(
      ...
      child: Column(
        ...
        children: <Widget>[
          Container(
            ...
            child: FxText.caption(title.toUpperCase(),
              ...
              Container(
                child: Row(
                  ...
                  children: <Widget>[
                    ...
                    FxText.caption(profit.abs().toStringAsFixed(2),
                        color: profit > 0
                            ? theme.colorScheme.primary
                            : theme.errorColor,
                        fontWeight: 500)
              ...
              Expanded(
                child: Center(
                  child: Column(
                    ...
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: <Widget>[
                      FxText.h6(units.toString(),
                          color: theme.colorScheme.onBackground,
                          letterSpacing: 0.3,
                          fontWeight: 600),
                      Container(
                          margin: EdgeInsets.only(top: 2),
                          child: FxText.b2("Units",
                              color:
                                  theme.colorScheme.onBackground.withAlpha(240),
                              letterSpacing: 0,
                              fontWeight: 500))
          ...
          Expanded(
            child: Container(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: <Widget>[
                  FxText.b1(name!, fontWeight: 600, letterSpacing: 0),
                  FxText.b2(
                    code!,
                    fontWeight: 500,
                  ),
