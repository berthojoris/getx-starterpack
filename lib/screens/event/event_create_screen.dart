            ...
            child: ListView(
              ...
              children: [
                ...
                Container(
                  ...
                  child: TextFormField(
                    style: FxTextStyle.h5(
                        color: theme.colorScheme.onBackground,
                        letterSpacing: -0.4,
                        fontWeight: 800),
                    decoration: InputDecoration(
                      fillColor: theme.colorScheme.background,
                      hintStyle: FxTextStyle.h5(
                          color: theme.colorScheme.onBackground,
                          letterSpacing: -0.4,
                          fontWeight: 800),
                      filled: false,
                  ...
                  child: Row(
                    children: [
                      Container(
                        ...
                        child: FxText.caption("Create".toUpperCase(),
                            fontSize: 12,
                            letterSpacing: 0.7,
        ...
        children: [
          Expanded(
            ...
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                FxText.b1("Public event",
                    color: theme.colorScheme.onBackground, fontWeight: 600),
                Container(
                  margin: FxSpacing.top(2),
                  child: FxText.caption("Add event to the public feed",
                      color: theme.colorScheme.onBackground,
                      fontWeight: 600,
                      xMuted: true),
                ),
