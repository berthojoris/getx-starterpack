          ...
          child: Column(
            children: [
              ...
              Container(
                ...
                child: FxText.h6("Martyn Rankin", fontWeight: 600),
              ),
            ],
          ),
        ),
        FxContainer.bordered(
          ...
          child: Row(
            ...
            children: [
              Column(
                children: [
                  FxText.caption("My balance".toUpperCase(),
                      fontSize: 12, fontWeight: 600, xMuted: true),
                  FxText.b2("\$ 24", fontWeight: 600),
                ],
              ),
              FxContainer(
