          ...
          children: <Widget>[
            Row(
              children: <Widget>[
                Expanded(
                  child: Center(
                    child: FxText.h6("Terms \& Conditions", fontWeight: 600),
                  ),
                ),
            ...
            Container(
              ...
              child: FxText.sh1("1. Return policy",
            ...
            Container(
              margin: EdgeInsets.only(top: 16),
              child: FxText.sh1("3. Coupon policy",
                  color: theme.colorScheme.primary, fontWeight: 600),
            ),
            Container(
              margin: EdgeInsets.only(top: 8),
              child: FxText.b2(text3,
                  color: theme.colorScheme.onBackground,
                  fontWeight: 500,
                  height: 1.25,
                  letterSpacing: 0.1),
            ...
            Container(
              margin: EdgeInsets.only(top: 16),
              child: FxText.sh1("4. Other",
                  color: theme.colorScheme.primary, fontWeight: 600),
            ),
            Container(
              margin: EdgeInsets.only(top: 8),
              child: FxText.b2(text4,
                  color: theme.colorScheme.onBackground,
                  fontWeight: 500,
                  height: 1.25,
                  letterSpacing: 0.1),
                ...
                child: Row(
                  ...
                  children: <Widget>[
                    TextButton(
                        ...
                        child: FxText.b2("Decline", fontWeight: 600)),
                    TextButton(
                        onPressed: () {
                          Navigator.pop(context);
                        },
