                    ...
                    child: Row(
                      children: <Widget>[
                        Container(
                            ...
                            child: FxText.caption(_time, fontWeight: 500)),
                        Expanded(
                          child: SliderTheme(
                        ...
                        Container(
                            ...
                            child: FxText.caption("3:20", fontWeight: 500)),
                      ],
                    ),
                  )
                ],
                      ...
                      children: <Widget>[
                        Expanded(
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: <Widget>[
                              FxText.b2("1.0 Introduction of UI Designing",
                                  color: theme.colorScheme.onBackground,
                                  fontWeight: 600),
                              Container(
              ...
              child: ListView(
                  ...
                  children: <Widget>[
                    ...
                    Container(
                      ...
                      child: Center(
                        child: FxText.caption("show all".toUpperCase(),
