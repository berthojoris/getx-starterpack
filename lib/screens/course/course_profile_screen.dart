            ...
            children: <Widget>[
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    FxText.b1("Denise Andrew",
                        color: theme.colorScheme.onBackground, fontWeight: 600),
                    FxText.caption("Regular profile",
  ...
  Widget upgradeWidget() {
    return FxContainer(
      ...
      child: Column(
        ...
        children: <Widget>[
          Container(
            child: FxText.sh1("Upgrade\nYour Account",
                fontWeight: 700, color: theme.colorScheme.onPrimary),
          ),
          Container(
            margin: FxSpacing.top(8),
            child: FxText.b2(_upgradeText,
          ...
          Container(
            ...
            child: FxText.b2("Upgrade", color: customTheme.onInfo),
          ),
        ],
      ),
    );
                  ...
                  Container(
                    ...
                    child: Row(
                      children: <Widget>[
                        ...
                        Container(
                          margin: FxSpacing.left(16),
                          child: FxText.caption(progress.toString() + "%",
                              color: theme.colorScheme.onBackground,
                              muted: true,
                              fontWeight: 600,
                              letterSpacing: 0.5),
