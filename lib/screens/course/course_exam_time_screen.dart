    ...
    return Scaffold(
      ...
      children: <Widget>[
        ...
        Container(
          ...
          child: Column(
            children: <Widget>[
              FxText.caption("If you have any queries about exam",
                  color: theme.colorScheme.onBackground),
              Container(
                ...
                child: FxButton(
                    ...
                    borderRadiusAll: 4,
                    onPressed: () {},
                    child: FxText.caption("Contact us".toUpperCase(),
                        fontSize: 12,
                        letterSpacing: 0.5,
                        fontWeight: 600,
                ...
                children: <Widget>[
                  ...
                  Expanded(
                    ...
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: <Widget>[
                        FxText.b2(teacherName,
                            color: theme.colorScheme.onBackground,
                            fontWeight: 600),
                        FxText.caption("Examine",
                            fontSize: 12,
