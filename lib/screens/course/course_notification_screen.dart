      ...
      child: Column(
        ...
        children: <Widget>[
          Container(
            ...
            child: FxText.sh2(title,
                color: theme.colorScheme.onBackground, fontWeight: 600),
          ),
          Container(
            padding: FxSpacing.horizontal(24),
            margin: FxSpacing.top(4),
            child: FxText.b2(desc,
                color: theme.colorScheme.onBackground,
                letterSpacing: 0.3,
                fontWeight: 500,
                height: 1.7),
          ...
          Container(
            ...
            child: Row(
              ...
              children: <Widget>[
                FxText.b2(date, color: theme.colorScheme.primary),
                FxText.b2(time, color: theme.colorScheme.primary),
              ],
            ),
          ),
          Container(
