  ...
  Widget examWidget() {
    return FxContainer.bordered(
      ...
      child: Column(
        ...
        children: <Widget>[
          Container(
            child: FxText.sh1("Mock Test\n21, July",
                fontWeight: 700, color: theme.colorScheme.onBackground),
          ),
          Container(
            margin: FxSpacing.top(8),
            child: FxText.b2(Generator.getDummyText(8),
