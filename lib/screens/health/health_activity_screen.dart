    ...
    return Scaffold(
      ...
      children: [
        ...
        Container(
          ...
          child: FxText.caption("Resume Activity".toUpperCase(),
              fontSize: 11.8,
              muted: true,
              color: theme.colorScheme.onBackground,
              fontWeight: 600),
            ...
            child: Container(
              ...
              child: Row(
                children: [
                  Expanded(
                    child:
                        FxText.b1(type, color: theme.colorScheme.onBackground),
                  ),
                  Expanded(
                    child: Center(
                      child: FxText.b1(inGram + " g",
                          color: theme.colorScheme.onBackground),
                    ),
                  ),
                  Expanded(
