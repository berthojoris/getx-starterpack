    ...
    return Scaffold(
      ...
      children: [
                ...
                children: [
                  ...
                  Expanded(
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        FxText.sh2("Maria M. Boyles",
                            color: theme.colorScheme.onBackground,
                            fontWeight: 700),
                        FxText.b2("Main Editor",
                            color: theme.colorScheme.onBackground,
                            letterSpacing: 0,
                            muted: true,
                            fontWeight: 600),
        ...
        Container(
          ...
          child: FxText.sh2("Based on the popularity of articles",
              color: theme.colorScheme.onBackground,
              fontWeight: 600,
              letterSpacing: 0,
              xMuted: true),
