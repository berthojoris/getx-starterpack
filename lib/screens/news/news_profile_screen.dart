...
class _NewsProfileScreenState extends State<NewsProfileScreen> {
                ...
                title: Column(
                  ...
                  children: [
                    FxText.b2("Email",
                        ...
                        xMuted: true,
                        fontWeight: 600),
                    FxText.sh2("maria@coderthemes.com",
  ...
  _upgradeWidget() {
    return Container(
      ...
      child: Column(
        children: [
          FxText.b1("Become Pro",
              color: theme.colorScheme.onBackground, fontWeight: 600),
          FxText.b2("Get more done with pro",
          ...
          Container(
            ...
            decoration: BoxDecoration(
                borderRadius: BorderRadius.all(Radius.circular(6)),
                color: theme.colorScheme.primary),
            child: FxText.caption("Upgrade now",
                color: theme.colorScheme.onPrimary,
                fontWeight: 600,
                letterSpacing: 0.3),
          )
