...
import 'package:digital/utils/generator.dart';
                    ...
                    InkWell(
                      ...
                      child: Row(
                        children: <Widget>[
                          ...
                          FxText.sh2("Price - ", fontWeight: 600),
                          FxText.sh2("High to Low", fontWeight: 500),
                        ],
                      ),
                    ),
                    InkWell(
                      ...
                      child: Row(
                        children: <Widget>[
                          ...
                          FxText.sh2("Price - ", fontWeight: 600),
                          FxText.sh2("Low to High", fontWeight: 500),
                        ],
                      ),
                    ),
                    InkWell(
                      ...
                      child: Row(
                        children: <Widget>[
                          ...
                          FxText.sh2("A to Z", fontWeight: 500),
                        ],
                      ),
                    ),
                    InkWell(
                      ...
                      child: Row(
                        children: <Widget>[
                          ...
                          FxText.sh2("Name - ", fontWeight: 600),
                          FxText.sh2("Z to A", fontWeight: 500),
                        ],
                      ),
                    ),
                  ],
          ...
          children: <Widget>[
            ...
            Container(
              ...
              child: Column(
                ...
                children: <Widget>[
                  FxText.b1(widget.name, fontWeight: 700, letterSpacing: 0),
                  Container(
                    ...
                    child: Row(
                      ...
                      children: <Widget>[
                        ...
                        Container(
                          ...
                          child: FxText.b2(widget.star.toString(),
                              fontWeight: 600),
                        ),
                      ],
                    ),
                  ...
                  Container(
                    ...
                    child: FxText.b2("\$ " + widget.price.toString(),
        ...
        children: <Widget>[
          ...
          Column(
            ...
            children: <Widget>[
              ...
              Container(
                padding: EdgeInsets.only(left: 16, right: 16, top: 16),
                child: FxText.b1("Rating", fontWeight: 600, letterSpacing: 0),
              ),
              Container(
              ...
              Container(
                padding: EdgeInsets.only(left: 16, right: 16, top: 16),
                child:
                    FxText.b1("Price Range", fontWeight: 600, letterSpacing: 0),
              ),
              Container(
