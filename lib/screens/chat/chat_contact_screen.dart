              ...
              child: Column(
                children: [
                  ListTile(
                    ...
                    title: FxText.b1("Invite Friends",
                        color: theme.colorScheme.onBackground,
                        letterSpacing: 0,
                        fontWeight: 600),
                  ),
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          FxText.caption("EMAIL",
                              fontSize: 12,
                              fontWeight: 700,
                              muted: true,
                              color: theme.colorScheme.onBackground,
                              letterSpacing: 0.5),
                          FxText.b1("elysin12@gmail.com",
                              fontWeight: 600,
                              color: theme.colorScheme.onBackground),
                        ],
                      ),
                    ...
                    Container(
                      ...
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          FxText.caption("NUMBER",
                              fontSize: 12,
                              fontWeight: 700,
                              muted: true,
                              color: theme.colorScheme.onBackground,
                              letterSpacing: 0.5),
                          FxText.b1("(91) 9876543210",
                              fontWeight: 600,
                              color: theme.colorScheme.onBackground),
                        ],
                      ),
                          ...
                          ElevatedButton(
                            style: ButtonStyle(
                                padding: MaterialStateProperty.all(
                                    FxSpacing.xy(16, 0))),
                            onPressed: () {},
                            child: FxText.b2("Send Message",
                                fontWeight: 600,
                                color: theme.colorScheme.onPrimary),
                          ),
                          TextButton(
                            onPressed: () {},
                            child: FxText.b2("Cancel Request",
                                fontWeight: 600,
                                color: theme.colorScheme.onBackground),
                          ),
                        ],
